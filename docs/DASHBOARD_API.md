...
The frontend view packet is also display-only. It combines the current-view brief, nearest-zone checklist, observed zone notes, multi-timeframe zone map, and observed-zones table for sharing; it does not add new calculations or interpretation beyond those visible sections.
