...
4. writes `_site/research_report.html`, `_site/research_summary.json`, `_site/artifact_report.html`, and `_site/dashboard.html`;
5. copies `_site/research_report.html` to `_site/index.html` as the Pages landing page;
...
```text
_site/index.html
_site/research_report.html
_site/research_summary.json
_site/artifact_report.html
_site/dashboard.html
_site/artifacts/
```

`index.html` is a copy of the research dataset report landing page. `artifact_report.html` remains the artifact-quality report, and `dashboard.html` is the static dashboard export generated by the same offline sample workflow.
...
cp .pages-preview/research_report.html .pages-preview/index.html
```

Verify that:

- `index.html` exists;
- `research_report.html` exists;
